...
export default function CardTable({ color }) {
  ...
  return (
    <>
      ...
      >
        <div className="block w-full overflow-x-auto h-500-px">
          {/* Projects table */}
              ...
              {data &&
                data.map((item) => (
                  <tr key={item._id.$oid}>
                    ...
                    <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                      {item.BikeID && item.BikeID.$numberInt}
                    </td>
                    <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                      {item.Make && item.Make}
                    </td>
                    ...
                    <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                      {item.Year && item.Year.$numberInt}
                    </td>
                    <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                      R {item.Price && item.Price.$numberInt}
                    </td>
                    <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                      {item.Displacement && item.Displacement.$numberInt}
                    </td>
                    <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                    ...
                    <td
                      ...
                      className="border-t-0 px-6 text-align-left-dev border-l-0 border-r-0 text-xs whitespace-nowrap p-4"
                    >
